    ...
    class Education_base_course extends WP_Widget {
        ...
        public function form( $instance ) {
	        ...
	        if( $page_id != 0 ) {
	            ?>
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'page_id' ) ); ?>"><?php _e( 'Select Parent Page For Course', 'education-base' ); ?>:</label>
                    <br />
        ...
        public function widget($args, $instance) {
            ...
            ?>
            <section id="<?php echo esc_attr( $unique_id ); ?>" class="acme-widgets popular-course">
                <div class="container">
                        ...
                        if( !empty( $education_base_child_page_args ) ):
                            ...
                            if ( $course_query->have_posts() ):
                                ...
                                while( $course_query->have_posts() ):$course_query->the_post();
                                    ...
                                    ?>
                                    <div class="course-item-wrapper <?php echo esc_attr( $init_animate_content ); ?>">
