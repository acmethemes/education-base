    ...
    class Education_base_gallery extends WP_Widget {
        ...
        public function form( $instance ) {
	        ...
	        if( $page_id != 0 ){
	            ?>
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'page_id' ) ); ?>"><?php _e( 'Select Parent Page For Gallery', 'education-base' ); ?>:</label>
                    <br />
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'post_number' ) ); ?>"><?php _e( 'Gallery Number', 'education-base' ); ?>:</label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'image_popup_type' ) ); ?>"><?php _e( 'Image Popup Type', 'education-base' ); ?>:</label>
        ...
        public function widget($args, $instance) {
            ...
            ?>
            <section id="<?php echo esc_attr( $unique_id ); ?>" class="acme-widgets acme-gallery">
