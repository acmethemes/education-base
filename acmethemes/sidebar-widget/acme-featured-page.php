...
if ( ! class_exists( 'Education_Base_fdcolumn' ) ) {
    ...
    class Education_Base_fdcolumn extends WP_Widget {
        ...
        public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'page_id' ) ); ?>"><?php _e( 'Select Feature Page', 'education-base' ); ?>:</label>
                <br />
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'image_align' ) ); ?>"><?php _e( 'Image Align', 'education-base' ); ?>:</label>
                ...
                if ( $featured_page_query->have_posts() ):
                    ...
                    while( $featured_page_query->have_posts() ):$featured_page_query->the_post();
                        ...
                        <section id="<?php echo esc_attr( $unique_id ); ?>" class="acme-widgets acme-featured-image <?php echo esc_attr( $alternate ); ?>">
                            <div class="container">
                                <div class="row">
                                    <div class="col-image col-md-6 <?php echo esc_attr( $animation1 ); ?>">
                                        <?php the_post_thumbnail( 'large', array( 'class' => 'col-img' ) ); ?>
                                    </div>
                                    <div class="col-md-6 <?php echo esc_attr( $animation2 ); ?>">
